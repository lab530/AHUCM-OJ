<template>
    <div class="box">
        <b-card class="problem">
            ...
            <div v-else>
                <div class="Title">Contest - {{1000 + contest.ID}} {{ contest.title }} - 题目列表</div>
                <hr>
                <div class="time">
                ...
                <div class="problemList">
                    <b-card>
                        <div class="overflow-auto" v-if="this.items">
                            ...
                            <div class="col-num" @click="navigateToProblem(data.item.ID)" >Problem {{ String.fromCharCode(65 + data.index) }}</div>
                            </template>  
...
export default {
    ...
    navigateToProblem(pid){
        ...
        if (isDuring(this.contestInfo)){
            this.$router.push("/problem" + queryParams + '&pid=' + pid);
        } else {
