        ...
        <b-card>
          <div v-if="!content">
            <b-button variant="outline-primary">
              <b-icon icon="arrow-counterclockwise" animation="spin-reverse"></b-icon>&nbsp;数据加载中
            </b-button>
          </div>
          <b-form-textarea
            v-else
          ...
          <div class="save-container">
            <b-button variant="outline-primary" size="sm" class="save" @click="save()">
...
export default {
  ...
  created() {
    this.GetCaseInfo().then((response) => {
  ...
  methods: {
    ...
    save(){
      this.UpdateCase(this.content).then(() => {
