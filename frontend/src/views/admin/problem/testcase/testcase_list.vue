<template>
    <div class = "box">
      ...
      <div class="upload">
        <b-form-file v-model="selectedFiles" multiple class = "chooseBox">
        ...
        <b-button variant="outline-primary" @click="uploadFiles">
          <b-icon icon="cloud-upload"></b-icon> 上传
        </b-button>
      </div>
        <div class="problemlist">
            <b-card>
                <div v-if="items" class="overflow-auto">
                    <b-table
                    id="my-table"
                    striped hover 
                    :items="items"
                    ...
                    <template #cell(操作)="data">
                      <div class = "operate">  
                        <div class="col-title">
                          <b-button size="sm" variant="outline-primary" @click = "GoEdit(data.item.name)">
                            <b-icon icon="code-square"></b-icon> 编辑
                          </b-button>
                        </div>
                        
                        <div class="col-title">
                          <b-button size="sm" variant="outline-primary" @click = "DeleteCase( data.item.name )">
...
export default {
  ...
  methods: {
    ...
    uploadFiles() {
      this.UploadFile(this.selectedFiles).then(() => {
